...
import com.github.princesslana.smalldkt.type.voice.PartialVoiceState
...
data class GuildCreateEvent(
    ...
    val voice_states: List<PartialVoiceState>? = null,
    val members: List<GuildMember>? = null,
    val channels: List<Channel>? = null,
    val presences: List<PresenceUpdateEvent>? = null
